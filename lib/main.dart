...
import 'package:zoukhapp/login/login_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<ZoukhappFirebaseUser> userStream;
  ZoukhappFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = zoukhappFirebaseUserStream()
